...
export const MODULES: Module[] = [
  ...
  },
  {
    ...
    status: "shipped",
    description:
      "Manager that proves whether a tool-using assistant treats retrieved document or tool-output content as instructions.",
    icon: ClipboardList,
    hasPage: true,
  },
  {
    name: "email-exfiltration-proof",
    slug: "email-exfiltration-proof",
    category: "attack",
    tier: 0,
    status: "shipped",
    description:
      "Manager that attempts the attacker-controlled email side effect and writes a proof dossier for dvllm's email scoreboard.",
    icon: Target,
    hasPage: true,
  },
